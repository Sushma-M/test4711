...
public class QueryExecutionController {
    ...
    @RequestMapping(value = "/queries/query123", method = RequestMethod.GET)
    public Page<Object> executeQuery123(Pageable pageable) {
        LOGGER.debug("Executing named query query123");
        Page<Object> result = queryService.executeQuery123(pageable);
